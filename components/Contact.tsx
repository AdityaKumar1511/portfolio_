  ...
  return (
    <section id="contact" className="contact-section">
      ...
      <div className="contact-socials">
        ...
        <a href="https://codolio.com" target="_blank" rel="noreferrer" className="contact-social-cell" aria-label="Codolio">
          <svg viewBox="0 0 24 24" fill="currentColor" className="contact-social-svg">
            <path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z" />
          </svg>
        </a>
        <a href="https://instagram.com" target="_blank" rel="noreferrer" className="contact-social-cell" aria-label="Instagram">
          <svg viewBox="0 0 24 24" fill="currentColor" className="contact-social-svg">
        ...
        <a href="https://x.com" target="_blank" rel="noreferrer" className="contact-social-cell" aria-label="X">
          <svg viewBox="0 0 24 24" fill="currentColor" className="contact-social-svg">
